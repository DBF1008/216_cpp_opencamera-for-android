...
#define CLASS_NAME_BYTEFLOW_RENDER "com/atech/glcamera/render/ByteFlowRender"
...
JNIEXPORT void JNICALL native_SetTransformMatrix
    ...
    ByteFlowRenderContext *pContext = ByteFlowRenderContext::GetRenderContext(env, instance);
    if (pContext)
        pContext->SetTransformMatrix(translateX, translateY, scaleX, scaleY, degree, mirror);
}
 ...
 */
JNIEXPORT void JNICALL
native_SetParamsInt(JNIEnv *env, jobject instance, jint paramType, jint param) {
    ByteFlowRenderContext *pContext = ByteFlowRenderContext::GetRenderContext(env, instance);
